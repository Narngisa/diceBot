...
class SavingThrow(commands.Cog):
    ...
    @app_commands.command(name="saving", description="Saving Throw with ability modifier")
    ...
    async def saving(self, interaction: discord.Interaction, ability: Literal["STR", "DEX", "INT", "CON", "WIS", "CHA"], modifiers: int):
        ...
        embed = discord.Embed(title=f"🛡️ You saving throw: {ability}", description=f"Modifiers: {mod_txt}", color=discord.Color.green())
